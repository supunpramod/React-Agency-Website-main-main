          ...
          {/* company stats */}
           <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver py-16'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                ...
                <h2 className='text-4xl text-neutralDGrey font-semibold  md:w-2/3'>Helping a local</h2> 
                <h2 className='text-brandPrimary text-4xl  font-semibold mb-4 md:w-2/3'>business reinvent itself</h2>
                ...
                <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center justify-around gap-12'>
                    <div className='space-y-8'>
                        <div className='flex items-center gap-4'>
                            <img src="/src/assets/icons/members.png" alt="image" className='w-12 h-12'/>
                            <div>
                         ...
                         <div className='flex items-center gap-4'>
                            <img src="/src/assets/icons/event.png" alt="image" className='w-12 h-12'/>
                            <div>
                     ...
                     <div className='space-y-8'>
                        <div className='flex items-center gap-4'>
                            <img src="/src/assets/icons/club.png" alt="image" className='w-12 h-12'/>
                            <div>
                         ...
                         <div className='flex items-center gap-4'>
                            <img src="/src/assets/icons/payment.png" alt="image" className='w-12 h-12'/>
                            <div>
